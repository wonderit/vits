...
parser.add_argument('--info',type=list, default=["kss"], help='dataset names')
parser.add_argument('--validation',type=int, default=100, help='validation holdout')
parser.add_argument('--holdout',type=int, default=100, help='testholdout')
